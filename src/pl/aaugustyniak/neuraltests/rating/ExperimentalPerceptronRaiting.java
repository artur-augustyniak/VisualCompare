 ...
 */
@Entity
@Table(name = "exp_peceptron_rating")
public class ExperimentalPerceptronRaiting implements RaitingPOJO {
    ...
    public ExperimentalPerceptronRaiting() {
    }

    public ExperimentalPerceptronRaiting(TrainingEfficiencyOutcomeObserver o, String name) {
        this.name = name;
...
//    }
    ...
    @ElementCollection
    @CollectionTable(name = "experimental_training_mse_readouts", joinColumns =
            @JoinColumn(name = "exp_trn_readout_id"))
    @Column(name = "exp_trn_readout")
    ...
    @ElementCollection
    @CollectionTable(name = "experimental_validation_mse_readouts", joinColumns =
            @JoinColumn(name = "exp_vali_readout_id"))
    @Column(name = "exp_vali_readout")
    ...
    @ElementCollection
    @CollectionTable(name = "experimental_efficiency_factor_readouts", joinColumns =
            @JoinColumn(name = "exp_eff_readout_id"))
    @Column(name = "exp_eff_readout")
